...
class emplyee :
    def __init__(self,root) :
        ...
        all_employees_btn = Button(self.root, text="All Employees", command=self.employee_frame, font=("times new roman", 14), bg="#f0f0f0",fg="black", relief=SOLID)
        ...
        lbl_code = Button(Frame1,text="Search",font=("times new roman",14),command=self.search, bg="#f0f0f0",fg="black",relief=SOLID).place(x=420,y=60)
        ...
        txt_gend = Entry(Frame1, font=("times new roman", 18),textvariable= self.var_gender , bg="white", fg="black").place(x=510, y=300, width=200)   
        ...
        lbl_Present = Label(Frame2,text="Base Days",font=("times new roman",18,),bg="white",fg="black").place(x=230,y=60)
       ...
       # .............row2...........
        ...
        btn_Save = Button(Frame2,text="Save",font=("times new roman",14),command= self.add, bg="#f0f0f0",fg="black",relief=SOLID,).place(x=280,y=240)
        btn_clear = Button(Frame2,text="Clear", command=self.clear,font=("times new roman",14),bg="#f0f0f0",fg="black",relief=SOLID).place(x=350,y=240)
        ...
        lbl_print = Button(sal_frame,text="Save", command=self.save_record,font=("times new roman",14),bg="#f0f0f0",fg="black",relief=SOLID,).place(x=100,y=215,width=60,height=35)
...
'''
        ...
        self.txt_salary_slip=Text(sal_frame2,font=("times new roman",13),bg="#f0f0f0",fg="black",yscrollcommand=scroll_y.set)
    ...
    def search(self):
        try:
            ...
            if row is  None:
              ...
              print(row)
              self.var_code.set(row[0]), self.var_desig.set(row[1]), self.var_name.set(row[2]), self.var_doj.set(row[3]),
    ...
    def add(self):
      ...
      try:
          ...
          if row is not None:
            ...
            cur.execute("INSERT INTO emp(e_id,Designation,Name,doj,Experience,Age,Proof,Gender,Email,Contact,Address,Base_Pay,Base_Days,Medical,Convinence,P_F,Net_Salary,reciept) VALUES (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s,%s, %s, %s,%s, %s, %s,%s)",
...
'''
    ...
    def employee_frame (self):
      ...
      title= Label(self.root2,text="All Employee Record",font=("times new roman",30,"bold"),bg="#ADD8E6",fg="black").place(x=0,y=0,relwidth=1)
